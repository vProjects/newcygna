    	...
    	<div class="row profile_body_row">
        	...
        	<div class="col-md-10 profile_left_part_outline">
            	<div class="advertisement_body_outline">
                	<h2 class="post_project_top_heading">The services and the products of us</h2>
                    <div class="hiring_freelancer_text_outline">
                    	<h4 class="finding_job_sub_heading">Sub Heading for Services</h4>
                        <ol>
                        ...
                        <h4 class="finding_job_sub_heading">Sub Heading for Products</h4>
