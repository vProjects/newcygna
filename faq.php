...
<div id="footer_outline">
	<div class="container">
    	<div class="row footer_row">
            ...
            <div class="col-md-3">
            	<h3 class="other_footer_part_heading">Secured Network</h3>
                <img src="img/sequred_network_icon.png" class="footer_part_icon">
                <h3 class="other_footer_part_heading">Payment Methods</h3>
                <img src="img/payment_method_icon.png">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <a href="#"><img src="img/header_logo.png" alt="logo" class="other_footer_company_logo"></a>
	...
	<div class="container">
    	<div class="row copyright_row">
        	<div class="col-md-12 copyright_text_position">
            	<p class="copyright_para">Copyright 2013 @ YourCompany.com | <a href="#">Terms Of Use</a> | <a href="#">Privacy Policy</a></p>
            </div>
        </div>
    </div>
</div>
